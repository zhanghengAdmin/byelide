...
<template>
  <div class="app-navigator">
    ...
    <div class="app-navigator-link-wrapper">
      <router-link class="app-navigator-link-item" v-for="item in linkItems" :key="item.value"
        :style="activeLink.includes(item.value) && { background: item.bg }" :to="`/app/${item.value}`">
        ...
        <div class="item-border" :style="activeLink.includes(item.value) ? { background: item.borderColor } : {}"></div>
      </router-link>
    </div>
